package pe.eveliz.springbatchdemo.config;
...
import pe.eveliz.springbatchdemo.listener.JobLoteMovimientosListener;
import pe.eveliz.springbatchdemo.model.MovimientoItem;
import pe.eveliz.springbatchdemo.model.MovimientoItemOut;
import pe.eveliz.springbatchdemo.processor.MovimientoItemProcessor;
import pe.eveliz.springbatchdemo.writer.MovimientoItemWriter;
...
public class JobLoteMovimientosConfig {
    ...
    public Step stepOne(){
        return stepBuilderFactory.get("stepOne")
                .<MovimientoItem, MovimientoItemOut> chunk(5)
                .reader(reader())
                .processor(processor())
                .writer(writer())
                .build();
